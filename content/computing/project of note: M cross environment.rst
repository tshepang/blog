...
If I had actually known of `M cross environment`__ (MXE), I would have
...
installing `a few build dependencies`__ and running ``make qt``. An hour
...
lot simpler than the scary mess that is `JHBuild`__.


__ http://mxe.cc
__ http://mxe.cc/#requirements-debian
__ https://live.gnome.org/Jhbuild
